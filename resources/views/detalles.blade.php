    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">Producto</h3>
                <div class="d-flex mb-3">
                    ...
                    <small class="pt-1">(50 valoraciones)</small>
                </div>
                <h3 class="font-weight-semi-bold mb-4">$150.00</h3>
                {{-- <p class="mb-4">Descripcion si tiene.</p> --}}
                <div class="d-flex mb-3">
                    <p class="text-dark font-weight-medium mb-0 mr-3">Opcion:</p>
                    <form>
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab-pane-1">
                        <h4 class="mb-3">Descripcion si tiene</h4>
